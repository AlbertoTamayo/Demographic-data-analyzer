...
def calculate_demographic_data(print_data=True):
    ...
    high_earners = df.loc[df['salary'] == '>50K', 'native-country'].value_counts() / df['native-country'].value_counts() * 100
    highest_earning_country = high_earners.idxmax()
    highest_earning_country_percentage = round(high_earners.max(), 1)
